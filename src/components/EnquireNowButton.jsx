    ...
    return (
        <>
            <button
                ...
                className="fixed right-0 top-1/2 z-50 transform -translate-y-1/2 bg-[#1e5593] text-white px-3.5 sm:px-4 text-sm sm:text-base py-3 rounded shadow-lg cursor-pointer"
            >
            ...
            <Modal
                ...
                className="bg-white px-6 py-6 rounded shadow-lg max-w-xl w-full mx-auto relative z-50"
